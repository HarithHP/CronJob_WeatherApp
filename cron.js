...
const url = 'https://jade-nice-deer.cyclic.app/wcast/addrecord';
...
function addWeatherRecords() {
    ...
    async function fetchData() {
        const url = 'https://jade-nice-deer.cyclic.app/district/getDistricts';
        const headers = {
...
function deleteWeatherRecords(){
    ...
    async function deleteWeatherCall(data) {
        const url = 'https://jade-nice-deer.cyclic.app/wcast/delete';
        const headers = {
            'authkey': process.env.AUTHKEY
        }
        try {
...
const task = cron.schedule('*/5 * * * *', addWeatherRecords);// '*/5 * * * *'
const task2=cron.schedule('0 0 * * *', deleteWeatherRecords);//'*/13 * * * * *'
